      ...
      <main className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200 pb-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3 text-center shadow-sm">
            <span className="text-[10px] uppercase font-bold text-slate-400">Skor Profil LinkedIn</span>
            <p className="font-display text-2xl font-bold text-blue-600">{score}/100</p>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4">
                <label className="block text-xs font-semibold text-slate-700">Tautan URL LinkedIn Anda</label>
              ...
              <div className="mt-6 space-y-3">
                <p className="text-xs font-bold text-slate-900">Checklist Kelengkapan Profil:</p>
                <div className="space-y-2 text-xs">
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-emerald-50 text-emerald-800 font-medium">
                  ...
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-amber-50 text-amber-800 font-medium">
                    <span>⚠️ Ringkasan (About) Butuh Keyword Industri</span>
                    <span className="font-bold">+20 Pts</span>
                  </div>
                  <div className="flex items-center justify-between p-2.5 rounded-xl bg-blue-50 text-blue-800 font-medium">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-bold text-slate-800">1. Rekomendasi Headline LinkedIn</label>
                  <button
                ...
                <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-xs font-medium text-slate-800 leading-relaxed">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-xs font-bold text-slate-800">2. Rekomendasi Deskripsi &quot;About / Ringkasan&quot;</label>
                  <button
              ...
              {/* Keywords Tag Cloud */}
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-800">3. Kata Kunci (Keywords) Wajib Disematkan:</label>
                <div className="flex flex-wrap gap-2 pt-1">
                  {activeTemplate.keywords.map((kw, idx) => (
                    <span
                      key={idx}
                      className="rounded-lg bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 border border-blue-200"
                    >
                      + {kw}
                    </span>
                  ))}
