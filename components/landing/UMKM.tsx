  ...
  return (
    <section className="py-12 md:py-16">
      <div className="mx-auto max-w-4xl px-4 lg:px-8">
        <Reveal>
          <div className="rounded-2xl border border-teal-200/60 bg-teal-50/40 px-8 py-10 text-center md:px-12">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--primary)]">
              Kolaborasi
            </p>
            <h2 className="font-display mt-3 text-2xl font-bold text-slate-900 md:text-3xl">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-600">
              ...
              dan{" "}
              <strong className="font-semibold text-slate-900">UMKM</strong>{" "}
