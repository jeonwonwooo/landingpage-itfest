...
export default function UploadSection() {
  return (
    <section className="border-y border-slate-200/80 bg-white py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 lg:px-8">
        ...
        <Reveal delay={1} className="mx-auto mt-12 max-w-xl">
          <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-8 md:p-10">
            ...
            <div className="mt-6 flex flex-col items-center rounded-xl border-2 border-dashed border-slate-200 bg-white px-6 py-10 text-center transition-colors hover:border-[var(--primary)]/40">
